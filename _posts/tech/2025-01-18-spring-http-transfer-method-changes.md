...
외부 시스템과의 통신을 디버깅 하는데 코드 레벨에서 너무 많은 시간을 소모했던 것을 되돌아보게 되었습니다.
단순하게 RestClient로 API를 호출하는 과정에서 제가 직접 제어하는 영역은 정말 좁다는 것을 느꼈고,
내부적으로 일어나는 전반적인 프로세스에 대한 이해가 문제 해결의 핵심이 될 수 있다는 교훈을 얻게 되었습니다.
